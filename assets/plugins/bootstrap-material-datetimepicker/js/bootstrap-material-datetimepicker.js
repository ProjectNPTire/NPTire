(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: true, format: 'YYYY-MM-DD', minDate: null, maxDate: null, currentDate: null, yearOffset:543, lang: 'th', weekStart: 0, shortTime: false, clearButton: false, nowButton: false, cancelText: 'ยกเลิก', okText: 'ตกลง', clearText: 'Clear', nowText: 'Now', switchOnClick: false};
