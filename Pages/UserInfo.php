            ...
            <form id="frm-input" method="post" enctype="multipart/form-data" action="process/profile_process.php" >
              ...
              <div class="body">
                ...
                <div class="row clearfix">
                  ...
                  <div class="col-md-4"> 
                    <div class="col-sm-12">
                      <img id="blah" src="<?php echo $proc == "add" ? '' : $path_pic."/".$rec['img'];?>" class="img-responsive" />
                    </div>
                  </div>
                </div>
                <div class="row clearfix">
                  <div class="col-sm-4">
                    ...
                    <div class="form-group">
                      <div class="form-line">
                        <input type="text" onchange="checkForm();return false;" onkeyup="chk_idcard();" class="form-control idcard" placeholder="9-9999-99999-99-9"  name="idcard" id="idcard"  value="<?php echo $rec['idcard'];?>"<?php echo $_SESSION["userType"] == "2" ? $readonly : '';?>>
                      </div>
                      ...
                      <label id="idcard-error3" class="error" for="idcard">มีเลขบัตรประชาชนนี้แล้ว</label>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <b>เบอร์โทรศัพท์</b>
  ...
  if (oInput.type == "file") {
    ...
    if (sFileName.length > 0) {
      ...
      function chk_idcard(){
        ...
        var userID = $('#userID').val();
        $.ajaxSetup({async: false});
        $.post('process/get_process.php',{proc:'chk_idcard',idcard:idcard,userID:userID},function(data){
          if(data==1){
           $('#idcard-error3').show();
           $('#idcard').focus();
           $('#chkidcard').val(1);
