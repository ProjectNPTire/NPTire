            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                             <form id="frm-search" method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-horizontal">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-3">
                                        <div class="form-group form-float">
                                            <b>เอกสาร</b>
                                            <select class="form-control show-tick" id="S_REPORT_TYPE" name="S_REPORT_TYPE">
                                    ...
                                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                     ...
                                     <!-- <fieldset>
                                       ...
                                       <div class="control-group">                     
                                          <label class="control-label">บรรทัดที่ 1</label>
                                          <div class="controls">
                                            <input type="text" class="span8" name="H_REPORT_1" id="H_REPORT_1" value="<?php echo trim($arrMenu['desc'][$act]['2_1']);?>" placeholder="">
                                          </div> 
                                        </div>
                                         <div class="control-group">                     
                                          <label class="control-label">บรรทัดที่ 2</label>
                                          <div class="controls">
                                            <input type="text" class="span8" name="H_REPORT_2" id="H_REPORT_2" value="<?php echo $head_2 ;?>" placeholder="">
                                          </div> 
                                        </div>
                                        <div class="control-group">                     
                                          <label class="control-label">บรรทัดที่ 3</label>
                                          <div class="controls">
                                            <input type="text" class="span8" name="H_REPORT_3" id="H_REPORT_3" value="" placeholder="<?php echo $H_REPORT_3;?>">
                                          </div> 
                                        </div>
