...
$table = "tb_product";
$pk_id = "productID";
$wh = "1=1 and productTypeID = 1 {$filter}";
                    ...
                    <tbody>
                      ...
                      if($nums>0){
                        ...
                        while ($rec = $db->db_fetch_array($query)) {
                          ...
                          $info = ' <a style="'.chk_role($page_key,'isSearch').'" class="btn btn-info btn-xs waves-effect" onClick="infoData('.$rec['productID'].');">'.$img_info.'</a>';
                          ?>
                          <tr>
